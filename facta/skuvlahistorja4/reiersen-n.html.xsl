...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/reiersen-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'– Den utdøende stammes frykt'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reiersen-s.html" xml:lang="sme"/>
</xsl:variable>
